...
class InferenceManager:
    ...
    def compare_with_baseline(
        ...
        model_result = self.evaluate_single_sample(
            model, processor, sample, instruction
        )
    ...
    def interactive_generation(
        ...
        instruction = (
            custom_instruction
            or "Generate the CADQuery code needed to create the CAD for the provided image. Just the code, no other words."
        )
    ...
    def generate_with_different_parameters(
        ...
        for i, params in enumerate(parameter_sets):
            ...
            generated_code = self.generate_cad_code(
                model, processor, image, messages, stream_output=False, **params
            )

            results.append({"parameters": params, "generated_code": generated_code})
